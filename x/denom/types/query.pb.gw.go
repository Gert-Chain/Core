...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"gertdenoms", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_DenomAuthorityMetadata_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2}, []string{"gertdenoms", "denom", "authority_metadata"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_DenomsFromCreator_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"gertdenoms", "by_creator", "creator"}, "", runtime.AssumeColonVerbOpt(true)))
)
