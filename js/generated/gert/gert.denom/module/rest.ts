...
export type DenomMsgBurnResponse = object;

export type DenomMsgChangeAdminResponse = object;

export interface DenomMsgCreateDenomResponse {
  new_token_denom?: string;
}

export type DenomMsgMintResponse = object;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/gertdenoms/by_creator/{creator}
   */
  queryDenomsFromCreator = (creator: string, params: RequestParams = {}) =>
    this.request<DenomQueryDenomsFromCreatorResponse, RpcStatus>({
      path: `/gertdenoms/by_creator/${creator}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/gertdenoms/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<DenomQueryParamsResponse, RpcStatus>({
      path: `/gertdenoms/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/gertdenoms/{denom}/authority_metadata
   */
  queryDenomAuthorityMetadata = (denom: string, params: RequestParams = {}) =>
    this.request<DenomQueryDenomAuthorityMetadataResponse, RpcStatus>({
      path: `/gertdenoms/${denom}/authority_metadata`,
      method: "GET",
      format: "json",
      ...params,
    });
