...
export const protobufPackage = "gert.scheduler";
...
export const CreateHookProposal = {
  ...
  decode(input: Reader | Uint8Array, length?: number): CreateHookProposal {
    ...
    const message = { ...baseCreateHookProposal } as CreateHookProposal;
    message.funds = [];
...
export const UpdateHookProposal = {
  ...
  decode(input: Reader | Uint8Array, length?: number): UpdateHookProposal {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseUpdateHookProposal } as UpdateHookProposal;
    message.funds = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
const baseDeleteHookProposal: object = { title: "", description: "", id: 0 };
...
export const DeleteHookProposal = {
  ...
  decode(input: Reader | Uint8Array, length?: number): DeleteHookProposal {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseDeleteHookProposal } as DeleteHookProposal;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
