...
import GertGertDenom from './gert/gert.denom'
import GertGertScheduler from './gert/gert.scheduler'
...
export default { 
  ...
  GertGertDenom: load(GertGertDenom, 'gert.denom'),
  GertGertScheduler: load(GertGertScheduler, 'gert.scheduler'),
